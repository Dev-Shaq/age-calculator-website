...
function calculateDate() {
    if (isValid) {
      ...
      // Create a date object with the age difference
...
//     // You can add validation here to check if the inputs are valid
...
//     // Update the output
//     document.querySelector(".output-year").textContent = Math.floor(ageInYears);
//   });
